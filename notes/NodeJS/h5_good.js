...
function () {
    ...
    function p() {
        ...
        te = [J, D, U, O, G, Q, q];
        for (var e = 0; e < te.length; e++) for (var i = 0; i < ne[e].length; i++) {
        ...
        se.addChild(re, le),
        new TWEEN.Tween(se.position).to({
                x: -1747
        ...
        ge.addChild(he, ce),
        new TWEEN.Tween(ge.position).to({
                x: -1635
        ...
        me = new TWEEN.Tween(ue.position).to({
                x: (B - 61) / 2 - 100
        ...
        I ? (Xe.visible = !1, We.visible = !1, Re.visible = !0) : (Xe.visible = !0, We.visible = !0, Re.visible = !1),
            ...
            if (!(e > 5)) {
                var i = parseInt(150 + 100 * Math.random()),
                    ...
                    t = new TWEEN.Tween({
                        ...
                        D.children[30].rotation = this.rotation,
                        D.children[31].rotation = this.rotation
    ...
    function u() {
        ...
        re.scale.set(.6),
        ge = new PIXI.extras.AnimatedSprite.fromImages([M + "5/1-0.png", M + "5/1-1.png", M + "5/1-2.png", M + "5/1-3.png", M + "5/1-4.png", M + "5/1-5.png", M + "5/1-6.png"]),
        ge.position.set(1478, 125),
        he = new PIXI.extras.AnimatedSprite.fromImages([M + "5/2-0.png", M + "5/2-1.png", M + "5/2-2.png", M + "5/2-3.png", M + "5/2-4.png", M + "5/2-5.png", M + "5/2-6.png"]),
        he.position.set(1737, 116),
        ce = new PIXI.extras.AnimatedSprite.fromImages([M + "5/3-0.png", M + "5/3-1.png", M + "5/3-2.png", M + "5/3-3.png", M + "5/3-4.png", M + "5/3-5.png", M + "5/3-6.png"]),
        ce.position.set(1901, 102),
        ue = new PIXI.extras.AnimatedSprite.fromImages([M + "5/4-0.png", M + "5/4-1.png", M + "5/4-2.png", M + "5/4-3.png", M + "5/4-4.png", M + "5/4-5.png", M + "5/4-6.png"]),
        ue.position.set(2141, 229),
        ve = new PIXI.extras.AnimatedSprite.fromImages([M + "5/6-0.png", M + "5/6-1.png", M + "5/6-2.png", M + "5/6-3.png", M + "5/6-4.png", M + "5/6-5.png", M + "5/6-6.png"]),
        ve.position.set(2141, 207),
        xe = new PIXI.extras.AnimatedSprite.fromImages([M + "5/5-0.png", M + "5/5-1.png", M + "5/5-2.png", M + "5/5-3.png", M + "5/5-4.png", M + "5/5-5.png", M + "5/5-6.png"]),
    ...
    function x() {
        X.removeChild(j),
        j = new C,
        j.position.set(0, 628);
        for (var e = 0; e < 7; e++) {
            var i = new A(T.resources[M + "text/" + e + ".png"].texture);
            i.visible = !1,
            i.position.x = (B - i.width) / 2,
            j.addChild(i)
        }
        X.addChild(j)
    }
    function v() {
        ...
        me.stop(),
        me = new TWEEN.Tween(ye.children[1].position).to({
            x: (B - 61) / 2 - 100
        }, 1e3).delay(300).repeat(1 / 0).easing(TWEEN.Easing.Quadratic.Out).start(),
    ...
    if (!b) {
        var w = 640,
            _ = window.innerHeight;
        return $(".china_tolerance_content").height(_),
    ...
    le = [M + "5/man1.png", M + "5/man2.png", M + "5/man3.png", M + "5/man4.png", M + "5/man5.png", M + "5/man6.png"],
    a(),
    ...
    var Me = isPlayedPaper = isPlayedGuitar1 = isPlayedGame = isPlayedCar = isPlayedPhoto = isPlayedMouth = isPlayedClose = isPlayedLaugh = !1,
        ...
        Fe = function (e, i, n) {
            ...
            if (o > 2050 && o < 2500) {
                ...
                J.alpha = l,
                J.scale.set(r, r),
                J.position.x = 2900 + 2 * a;
                var g = Math.min(1, .8 + a / 500);
                D.position.x = 2762 - .05 * a,
                U.position.x = 2762 - .05 * a,
                D.scale.set(g, g),
                U.scale.set(g, g)
            } else o <= 2050 && o > 850 ? (J.scale.set(1, 1), J.alpha = 1, J.position.x = 2900, D.position.x = 2762 - .05 * (o - 2050), U.position.x = 2762 - .05 * (o - 2050), D.scale.set(.8, .8), U.scale.set(.8, .8)) : o >= 2500 && (J.scale.set(10, 10), J.alpha = 0, D.scale.set(1, 1), U.scale.set(1, 1));
            if (o > 2100 && o < 5450) {
                ...
                if (o < 2368) {
                    var a = o - 2100;
                    D.children[9].rotation = -a / 250,
                    D.children[10].rotation = a / 250
                }
                if (o < 3e3 && o > 2300) {
                    var a = o - 2300;
                    D.children[22].rotation = -a / 400
                }
                if (o < 2400) for (var a = o - 2100, x = 12 + parseInt(a / 50), d = 13; d < 18; d++) d <= x ? D.children[d].visible = !0 : D.children[d].visible = !1;
                else {
            ...
            if (o > 3800 && o < 1e4) {
                ...
                if (o > 4500) {
                    ...
                    if (O.children[16].position.x = 1300 - a / 2, o > 5700) {
                        ...
                        O.children[13].position.x = O.children[13].data.position.x + 500 * O.children[13].data.speed.x + a * (O.children[13].data.speed.x + .5),
                        O.children[14].position.x = O.children[14].data.position.x + 500 * O.children[14].data.speed.x + a * (O.children[14].data.speed.x + .5),
                    ...
                    if (o > 6730) {
                        ...
                        O.children[16].position.x = 1215 - a / 2,
                        O.children[15].position.x = 1085 - a / 2
                    }
                }
            }
            if (o > 6600 && o < 1e4) {
                ...
                if (z.position.x = 7870 + (b - 5200) / 2 - .1 * (b - 5200) - .5 * a, Y.position.x = .1 * (b - 5200) - a - 1e3 - 100, G.position.x = a + b, o >= b + 1580 && o <= b + 1740) {
                    ...
                    } else if (o < b + 1580) G.children[2].rotation = 0,
                G.children[3].rotation = 0,
                G.children[3].position.set(261.5, 708.5);
                        ...
                        G.children[5].scale.set(12 * se),
                        G.children[6].scale.set(2.4 * se);
                        ...
                        for (var a = o - (b + 2355), _ = Math.max(3 - a / 100, 0), d = 0; d < ae.children.length; d++) {
                            var p = ae.children[d];
                            p.rotation = p.data.rotate + a / 10 * p.data.rotationSpeed,
                            p.scale.set(_)
                        }
                    }
            }
            if (o > 8800 && o < 11850) {
                ...
                } else if (o > 9560 && o < 9800) Q.children[15].visible = !0,
                ie.visible = !1;
                else if (o < 9400) {
                    ie.visible = !0,
                    Q.children[15].visible = !1;
                ...
                if (o < 9560) {
                    ...
                    Q.children[5].alpha = Math.max(.5 - a / 200, 0),
            ...
            if (o > 11800) {
                ...
                if (K.scale.set(1 + s), K.alpha = a / 300, o > 14300 ? (Z.children[0].visible = !0, Z.children[1].visible = !0, Z.children[2].visible = !0) : (Z.children[0].visible = !1, Z.children[1].visible = !1, Z.children[2].visible = !1), o > 14500 && o <= 15750) {
                    var a = o - 13700 - 800;
                    K.gotoAndStop(Math.min(a / 80, 15)),
                    Ae = 100 * Math.max(1 - a / 1280, .05)
                } else o <= 14500 && (Ae = 100);
                if (o > 15750) {
                    var f = o - 14950 - 800;
                    ...
                    je || (je = !0, y())
                } else Je && (clearInterval(Je), Je = null),
                je = !1,
