!(function() {
    ...
    (w = window.innerWidth),
      ...
      w < _
        ? ((k = w / 750),
          ...
          $("#loading").css({
            "-webkit-transform":
              "rotate(90deg) scale(" + k + ") translate3d(0,-750px,0)",
            width: _ / k,
            height: "750px"
          }),
          $(".loading_logo").css({
        ...
        : //   宽度大于高度，设置loading样式
          ...
          $("#loading").css({
            "-webkit-transform":
              "rotate(0deg) scale(" + k + ") translate3d(0,0,0)",
            width: w / k,
            height: "750px"
          }),
          $(".loading_logo").css({
  ...
  function p() {
    ...
    for (var e = 0; e < te.length; e++)
      for (var i = 0; i < ne[e].length; i++) {
        ...
        if (
          ...
          ((1 == e && 30 == i) || (1 == e && 31 == i)) &&
            (n.pivot.set(44, 6), (n.rotation = -0.5)),
          4 == e && 2 == i && n.pivot.set(85, 7),
          4 == e && 3 == i && n.pivot.set(21.5, 21.5),
          4 == e && 4 == i && (n.pivot.set(41, 57), n.position.set(589, 410)),
          4 == e &&
            5 == i &&
            (n.pivot.set(41, 57), n.position.set(589, 410), (n.visible = !1)),
          4 == e &&
            6 == i &&
            (n.pivot.set(205, 285),
            n.position.set(589, 410),
            (n.visible = !1),
            n.scale.set(0.2, 0.2)),
          te[e].addChild(n),
          4 == e && 6 == i)
          ...
          for (var h = 0; h < ke.length; h++) {
            ...
            c.pivot.set(ke[h].pivot.x, ke[h].pivot.y),
              c.position.set(
                ke[h].position.x + ke[h].pivot.x,
                ke[h].position.y + ke[h].pivot.y
              ),
              (c.data = ke[h]),
              c.scale.set(3),
        ...
        6 == e &&
          0 == i &&
          ((de = new PIXI.extras.AnimatedSprite.fromImages(pe)),
          q.addChild(de));
      }
    var oe = new E();
    oe.beginFill(4158644),
      ...
      (F = new PIXI.extras.AnimatedSprite.fromImages([
        M + "start/eye_open.png",
        M + "start/eye_close.png"
      ])),
  ...
  function u() {
    (oe = new PIXI.extras.AnimatedSprite.fromImages(Ee)),
      (se = 1),
      w < _
        ? _ / k > 1206 && (se = _ / k / 1206)
        : w / k > 1206 && (se = w / k / 1206),
  ...
  f ||
    h5Share.init({
      ...
      img:
        "http://cms-bucket.nosdn.127.net/15447b3150fc427789fa41225d843b2b20170914111552.jpeg"
    });
  var k,
    _ = window.innerHeight,
    w = window.innerWidth,
    ...
    Fe = function(e, i, n) {
      ...
      if ((Te > 0 ? ((o = i), (t = e)) : ((o = e), (t = i)), o < 850)) {
        ...
        if (
          (F.scale.set(1 + s),
          o > 150
            ? ((H.children[0].visible = !1),
              (H.children[1].visible = !1),
              (H.children[2].visible = !1))
            : ((H.children[0].visible = !0),
              (H.children[1].visible = !0),
              (H.children[2].visible = !0)),
          o > 550)
        ) {
          var a = o - 550;
          H.alpha = 1 - a / 300;
      ...
      if (o > 2100 && o < 5450) {
        ...
        if (o < 2400)
          for (var a = o - 2100, x = 12 + parseInt(a / 50), d = 13; d < 18; d++)
            d <= x
              ? (D.children[d].visible = !0)
              : (D.children[d].visible = !1);
        else {
      ...
      if (o > 3800 && o < 1e4) {
        ...
        for (var d = 0; d < O.children.length; d++) {
          ...
          p.data.speed &&
            ...
            (p.position.y = p.data.position.y + p.data.speed.y * a)),
            11 == d &&
              ((p.children[1].rotation = -a / 12 / 2),
              (p.children[2].rotation = -a / 12 / 2)),
            12 == d &&
              ((p.children[1].rotation = -a / 10 / 2),
              (p.children[2].rotation = -a / 10 / 2)),
            13 == d &&
              ((p.children[1].rotation = a / 15 / 2),
              (p.children[2].rotation = a / 15 / 2)),
            14 == d &&
              ((p.children[1].rotation = a / 5 / 2),
              (p.children[2].rotation = a / 5 / 2));
        }
        if (o > 4500) {
          var a = o - 4500;
          if (((O.children[16].position.x = 1300 - a / 2), o > 5700)) {
            for (var a = o - 5700, d = 0; d < 11; d++) {
              ...
              p.data.speed &&
                ((p.position.x =
                  p.data.position.x + 500 * p.data.speed.x + a / 2),
      ...
      if (o > 6600 && o < 1e4) {
        ...
        if (
          ...
          if (w > 9)
            for (var d = 0; d < G.children.length - 1; d++)
              G.children[d].visible = !1;
          else
            for (var d = 0; d < G.children.length - 1; d++)
              G.children[d].visible = !0;
          (G.children[5].visible = !1),
            (G.children[6].visible = !1),
            (oe.visible = !0),
            oe.gotoAndStop(w);
          for (
            var a = o - (b + 2355), _ = Math.max(3 - a / 100, 0), d = 0;
            d < ae.children.length;
            d++
          ) {
            var p = ae.children[d];
      ...
      if (o > 8800 && o < 11850) {
        ...
        } else if (o > 9560 && o < 9800)
          (Q.children[15].visible = !0), (ie.visible = !1);
        else if (o < 9400) {
          (ie.visible = !0), (Q.children[15].visible = !1);
          var a = o - 8600 - 800;
          (ie.position.y = 10 * a),
      ...
      if (o >= 11250) {
        ...
        if (
          ...
          (ge.position.x = 1478 - a),
            ...
            xe.gotoAndStop(a / 20);
          for (var d = 9; d <= 12; d++)
            q.children[d].position.x = q.children[d].data.position.x - a;
          if (o < 12310) {
            ve.visible = !1;
      ...
      if (o > 11800) {
        ...
        if (
          ...
          (K.alpha = a / 300),
          o > 14300
            ? ((Z.children[0].visible = !0),
              (Z.children[1].visible = !0),
              (Z.children[2].visible = !0))
            : ((Z.children[0].visible = !1),
              (Z.children[1].visible = !1),
              (Z.children[2].visible = !1)),
          o > 14500 && o <= 15750)
        ) {
          var a = o - 13700 - 800;
          K.gotoAndStop(Math.min(a / 80, 15)),
            (Ae = 100 * Math.max(1 - a / 1280, 0.05));
        } else o <= 14500 && (Ae = 100);
        if (o > 15750) {
          var f = o - 14950 - 800;
            ...
            : o >= 3100 && o < 4300
              ...
              : o >= 4300 && o < 4800
                ...
                : o >= 4800 && o < 7600
                  ...
                  : o >= 7600 && o < 8050
                    ? ((j.children[2].visible = !1),
                      (j.children[3].visible = !1))
                    : o >= 8050 && o < 9350
                      ? (j.children[3].visible = !0)
                      : o >= 9350 && o < 9600
                        ? ((j.children[3].visible = !1),
                          (j.children[4].visible = !1))
                        : o >= 9600 && o < 11150
                          ? (j.children[4].visible = !0)
                          : o >= 11150 && o < 11400
                            ? ((j.children[4].visible = !1),
                              (j.children[5].visible = !1))
                            : o >= 11400 && o < 13900
                              ? (j.children[5].visible = !0)
                              : o >= 13900 && o < 14500
                                ? ((j.children[5].visible = !1),
                                  (j.children[6].visible = !1))
                                : o >= 14500 && o < 15750
