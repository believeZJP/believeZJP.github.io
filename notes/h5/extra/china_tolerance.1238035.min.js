!(function() {
        ...
        (w = window.innerWidth),
            ...
            w < _
                ? ((k = w / 750),
                  ...
                  $('.loading_logo').css({ left: (_ / k - 242) / 2 + 'px' }),
                  $('.loading_main').css({ left: (_ / k - 283) / 2 + 'px' }))
                : ((k = _ / 750),
                  (B = w / k),
                  $('#loading').css({
                  ...
                  $('.loading_logo').css({ left: (w / k - 242) / 2 + 'px' }),
                  $('.loading_main').css({ left: (w / k - 283) / 2 + 'px' }));
    }
    function s() {
    ...
    function p() {
            ...
            for (var i = 0; i < ne[e].length; i++) {
                ...
                if (0 == i && 0 == e) {
                    ...
                    u.beginFill(6737151),
                        ...
                        u.endFill(),
                        (u.data = { position: { x: 545, y: 321 }, speed: { x: 0.05, y: 0 } }),
                        J.addChild(u);
                    var v = new E();
                    v.beginFill(0),
                        v.drawRect(0, 0, 83, 158),
                        v.endFill(),
                        (v.data = { position: { x: 846, y: 162 }, speed: { x: 0.05, y: 0.1 } }),
                        (v.mask = u),
                    ...
                    y.beginFill(0),
                        ...
                        y.endFill(),
                        (y.data = { position: { x: 846, y: 380 }, speed: { x: 0.05, y: -0.1 } }),
                        (y.mask = u),
                ...
                if (
                    (3 == e &&
                        ...
                        Y.endFill(),
                        (Y.data = { position: { x: 0, y: 0 }, speed: { x: -0.1, y: 0 } }),
                        (O.mask = Y),
                        O.addChild(Y)),
                    5 == e && 10 == i && (n.alpha = 0),
                    ...
                    K.pivot.set(113, 130),
                        ...
                        (ie.data = { position: { x: 477, y: 0 }, speed: 0 }),
        ...
        le.position.set(1747, 0),
            se.addChild(re, le),
            new TWEEN.Tween(se.position).to({ x: -1747 }, 9e4).repeat(1 / 0).start();
        var ge = new C();
        ...
        ce.position.set(1635, 0),
            ge.addChild(he, ce),
            new TWEEN.Tween(ge.position).to({ x: -1635 }, 3e4).repeat(1 / 0).start(),
            (L = new E()),
            L.beginFill(6737151),
        ...
        Be = setInterval(function() {
            ...
            if (!(e > 5)) {
                var i = parseInt(150 + 100 * Math.random()),
                    n = 0.2 * Math.random(),
                    t = new TWEEN.Tween({ rotation: -0.5 })
                        .to({ rotation: -n }, i)
                        .onUpdate(function() {
    ...
    for (
        var R,
            ...
            me,
            be = [
                { name: 'bg', url: M + '1/bg.png', position: { x: 535, y: 0 }, speed: { x: 0.05, y: 0 } },
                { name: 'curtain', url: M + '1/curtain.png', position: { x: 985, y: 40 }, speed: { x: 0.05, y: 0 } },
                { name: 'mother', url: M + '1/mother.png', position: { x: 1050, y: 245 }, speed: { x: -0.25, y: 0 } },
                { name: 'child', url: M + '1/child.png', position: { x: 808, y: 392 }, speed: { x: 0.05, y: 0 } },
                { name: 'cover', url: M + '1/cover.png', position: { x: -244, y: 0 }, speed: 0 },
                { name: 'tree', url: M + '1/tree.png', position: { x: 0, y: 285 }, speed: { x: 0.5, y: 0 } }
            ],
            we = [
                { name: 'bg', url: M + '2/bg.jpg', position: { x: 0, y: 0 }, speed: { x: -0.1, y: 0 } },
                { name: 'bg', url: M + '2_1/bg.jpg', position: { x: 0, y: 0 }, speed: { x: -0.1, y: 0 } },
                { name: 'balloon', url: M + '2/balloon.png', position: { x: 1141, y: 52 }, speed: { x: -0.08, y: 0 } },
                {
                    name: 'balloon1',
                ...
                { name: 'bed_boy', url: M + '2/bed_boy.png', position: { x: 2216, y: 97 }, speed: { x: -0.08, y: 0 } },
                {
                    name: 'bed_boy',
                ...
                { name: 'bed', url: M + '2/bed.png', position: { x: 1905, y: 197 }, speed: { x: -0.08, y: 0 } },
                { name: 'bed', url: M + '2_1/bed.png', position: { x: 1905, y: 197 }, speed: { x: -0.08, y: 0 } },
                {
                    name: 'mother_body',
                ...
                { name: 'desk', url: M + '2/desk.png', position: { x: 40, y: 592 }, speed: 0 },
                { name: 'desk', url: M + '2_1/desk.png', position: { x: 40, y: 592 }, speed: 0 },
                { name: 'book', url: M + '2/book.png', position: { x: 715, y: 571 }, speed: { x: 0, y: 0 } },
                { name: 'book1', url: M + '2/book1.png', position: { x: 385, y: 566 }, speed: { x: 0, y: 0 } },
                { name: 'book2', url: M + '2/book2.png', position: { x: 389, y: 533 }, speed: { x: 0, y: 0 } },
                { name: 'book3', url: M + '2/book3.png', position: { x: 721, y: 539 }, speed: { x: 0, y: 0 } },
                { name: 'book4', url: M + '2/book4.png', position: { x: 723, y: 494 }, speed: { x: 0, y: 0 } },
                { name: 'boy', url: M + '2/boy.png', position: { x: 520, y: 303 }, speed: { x: 0, y: 0 } },
                { name: 'photo', url: M + '2/photo.png', position: { x: 1008, y: 525 }, speed: { x: 0, y: 0 } },
                { name: 'photo1', url: M + '2/photo1.png', position: { x: 1170, y: 483 }, speed: { x: 0, y: 0 } },
                { name: 'lamp', url: M + '2/lamp.png', position: { x: 837, y: 416 }, speed: { x: 0, y: 0 } },
                { name: 'light', url: M + '2/light.png', position: { x: 875, y: 410 }, speed: { x: 0, y: 0 } },
                { name: 'thing', url: M + '2/thing.png', position: { x: 1525, y: 601 }, speed: { x: 0, y: 0 } },
                { name: 'boy1', url: M + '2/boy1.png', position: { x: 1702, y: 310 }, speed: { x: 0, y: 0 } },
                { name: 'thing1', url: M + '2/thing1.png', position: { x: 1959, y: 572 }, speed: { x: 0, y: 0 } },
                {
                    name: 'guitar_boy',
                ...
                { name: 'guitar', url: M + '2/guitar.png', position: { x: 2292, y: 389 }, speed: { x: 0, y: 0 } },
                { name: 'guitar', url: M + '2_1/guitar.png', position: { x: 2292, y: 389 }, speed: { x: 0, y: 0 } },
                {
                    name: 'guitar_hand',
                ...
                { name: 'boy2', url: M + '2/boy2.png', position: { x: 2554, y: 213 }, speed: { x: -0.05, y: 0 } }
            ],
            _e = [
                {
                    name: 'balloon',
                ...
                { name: 'photo', url: M + '2_1/photo.png', position: { x: 1008, y: 525 }, speed: 0 },
                { name: 'photo1', url: M + '2_1/photo1.png', position: { x: 1170, y: 483 }, speed: 0 },
                { name: 'thing', url: M + '2/thing.png', position: { x: 1525, y: 601 }, speed: 0 },
                { name: 'boy1', url: M + '2_1/boy1.png', position: { x: 1702, y: 310 }, speed: 0 },
                { name: 'thing1', url: M + '2_1/thing1.png', position: { x: 1959, y: 572 }, speed: 0 },
                { name: 'boy2', url: M + '2_1/boy2.png', position: { x: 2554, y: 213 }, speed: { x: -0.05, y: 0 } }
            ],
            fe = [
                { name: 'bg', url: M + '3/bg.jpg', position: { x: 0, y: 0 }, speed: { x: 0, y: 0 } },
                { name: 'moon', url: M + '3/moon.png', position: { x: 30, y: 23 }, speed: { x: -0.03, y: 0 } },
                { name: 'cloud', url: M + '3/cloud.png', position: { x: 169, y: 49 }, speed: { x: -0.06, y: 0 } },
                { name: 'back_bg', url: M + '3/back_bg.png', position: { x: 75, y: 0 }, speed: { x: -0.18, y: 0 } },
                { name: 'front_bg', url: M + '3/front_bg.png', position: { x: -400, y: 40 }, speed: { x: -0.5, y: 0 } },
                { name: 'man1', url: M + '3/man1.png', position: { x: 304, y: 539 }, speed: { x: -0.32, y: 0 } },
                { name: 'man2', url: M + '3/man2.png', position: { x: 2371, y: 482 }, speed: { x: -0.32, y: 0 } },
                { name: 'tree_big', url: M + '3/tree_big.png', position: { x: 842, y: 0 }, speed: { x: -0.38, y: 0 } },
                {
                    name: 'tree_small',
                ...
                { name: 'car3', url: M + '3/car3.png', position: { x: 736, y: 550 }, speed: { x: -0.8, y: 0 } },
                { name: 'car4', url: M + '3/car4.png', position: { x: 2159, y: 547 }, speed: { x: -1, y: 0 } },
                { name: 'car2', url: M + '3/car2.png', position: { x: 1246, y: 550 }, speed: { x: 0.3, y: 0 } },
                { name: 'car1', url: M + '3/car1.png', position: { x: 117, y: 560 }, speed: { x: 1, y: 0 } },
                { name: 'third', url: M + '3/third.png', position: { x: 1579, y: 345 }, speed: { x: 0, y: 0 } },
                { name: 'couple', url: M + '3/couple.png', position: { x: 1500, y: 268 }, speed: { x: 0, y: 0 } }
            ],
            Ie = [
                { name: 'bg', url: M + '3_1/bg.jpg', position: { x: 0, y: 0 }, speed: 0 },
                { name: 'child', url: M + '3_1/child.png', position: { x: 135, y: 502 }, speed: 0 },
                { name: 'leg', url: M + '3_1/leg.png', position: { x: 175, y: 634 }, speed: 0 },
                { name: 'ball', url: M + '3_1/ball.png', position: { x: 261.5, y: 708.5 }, speed: 0 },
                { name: 'boy2', url: M + '3_1/boy2.png', position: { x: 543, y: 353 }, speed: 0 },
                { name: 'boy1', url: M + '3_1/boy1.png', position: { x: 543, y: 353 }, speed: 0 },
                { name: 'boy', url: M + '3_1/boy.png', position: { x: 543, y: 353 }, speed: 0 }
            ],
            ke = [
                {
                    name: 'body',
            ...
            Se = [
                { name: 'bg', url: M + 'start/bg.jpg', position: { x: 0, y: 0 }, speed: 0 },
                { name: 'star', url: M + '4/star.png', position: { x: 94, y: 165 }, speed: { x: -0.05, y: 0 } },
                { name: 'cloud', url: M + '4/cloud.png', position: { x: 0, y: 27 }, speed: { x: -0.08, y: 0 } },
                { name: 'building', url: M + '4/building.png', position: { x: 50, y: 229 }, speed: { x: -0.13, y: 0 } },
                { name: 'file', url: M + '4/file.png', position: { x: 2029, y: 147 }, speed: 0 },
                { name: 'file1', url: M + '4/file1.png', position: { x: 2661, y: 163 }, speed: 0 },
                { name: 'wall', url: M + '4/wall.png', position: { x: 2400, y: 450 }, speed: 0 },
                { name: 'wall_night', url: M + '4/wall_night.png', position: { x: 2400, y: 450 }, speed: 0 },
                { name: 'people5', url: M + '4/people5.png', position: { x: 184, y: 318 }, speed: 0 },
                { name: 'desk', url: M + '4/desk.png', position: { x: 0, y: 334 }, speed: 0 },
                { name: 'desk1', url: M + '4/desk1.png', position: { x: 0, y: 334 }, speed: 0 },
                { name: 'light', url: M + '4/light.png', position: { x: 0, y: 0 }, speed: 0 },
                { name: 'light2', url: M + '4/light2.png', position: { x: 0, y: 0 }, speed: 0 },
                { name: 'people4', url: M + '4/people4.png', position: { x: 0, y: 402 }, speed: 0 },
                { name: 'people3', url: M + '4/people3.png', position: { x: 746, y: 345 }, speed: 0 },
                { name: 'man', url: M + '4/man.png', position: { x: 462, y: 363 }, speed: 0 },
                { name: 'seat', url: M + '4/seat.png', position: { x: 28, y: 453 }, speed: 0 },
                { name: 'people2', url: M + '4/people2.png', position: { x: 993, y: 252 }, speed: 0 },
                { name: 'people1', url: M + '4/people1.png', position: { x: 243, y: 266 }, speed: 0 },
                {
                    name: 'big_head',
            ...
            Pe = [
                { name: 'bg', url: M + 'start/bg.jpg', position: { x: -1300, y: 0 }, speed: 0 },
                { name: 'thing1', url: M + '5/thing1.png', position: { x: 1516, y: 329 }, speed: 0 },
                { name: 'thing2', url: M + '5/thing2.png', position: { x: 1731, y: 350 }, speed: 0 },
                { name: 'thing3', url: M + '5/thing3.png', position: { x: 1965, y: 400 }, speed: 0 },
                { name: 'thing5', url: M + '5/thing5.png', position: { x: 2494, y: 367 }, speed: 0 }
            ],
            Ce = null,
            Te = 0,
            Ae = 0,
    ...
    var Me = (isPlayedPaper = isPlayedGuitar1 = isPlayedGame = isPlayedCar = isPlayedPhoto = isPlayedMouth = isPlayedClose = isPlayedLaugh = !1),
        Xe = [
            { video: $('#close')[0], start: 1120, end: 1500, isPlayed: !1 },
            { video: $('#paper')[0], start: 2100, end: 2400, isPlayed: !1 },
            { video: $('#photo')[0], start: 2700, end: 3400, isPlayed: !1 },
            { video: $('#mix')[0], start: 3100, end: 4700, isPlayed: !1 },
            { video: $('#car')[0], start: 5e3, end: 7800, isPlayed: !1 },
            { video: $('#mouth')[0], start: 6730, end: 7e3, isPlayed: !1 },
            { video: $('#ball')[0], start: 8300, end: 8600, isPlayed: !1 },
            { video: $('#hit')[0], start: 8500, end: 9300, isPlayed: !1 },
            { video: $('#chair')[0], start: 9600, end: 10200, isPlayed: !1 },
            { video: $('#type')[0], start: 9650, end: 11150, isPlayed: !1 },
            { video: $('#snow')[0], start: 11600, end: 13900, isPlayed: !1 },
            { video: $('#swish1')[0], start: 12310, end: 12535, isPlayed: !1 },
            { video: $('#swish2')[0], start: 12535, end: 12740, isPlayed: !1 },
            { video: $('#swish3')[0], start: 12740, end: 12985, isPlayed: !1 },
            { video: $('#swish4')[0], start: 12985, end: 13210, isPlayed: !1 },
            { video: $('#swish5')[0], start: 13210, end: 13350, isPlayed: !1 },
        ...
        Le = !1,
        Ne = new Scroller(Fe, { zooming: !1, animating: !0, bouncing: !1, animationDuration: 1e3 });
